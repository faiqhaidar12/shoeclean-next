      ...
      <div className="max-w-4xl">
        <OutletForm
          ...
          initialValues={{
            ...
            pickup_enabled: data.outlet.pickup_enabled,
            delivery_enabled: data.outlet.delivery_enabled,
            pickup_fee: data.outlet.pickup_fee,
            delivery_fee: data.outlet.delivery_fee,
            pickup_base_distance_km: data.outlet.pickup_base_distance_km,
            pickup_base_fee: data.outlet.pickup_base_fee,
            pickup_extra_fee_per_km: data.outlet.pickup_extra_fee_per_km,
            delivery_base_distance_km: data.outlet.delivery_base_distance_km,
            delivery_base_fee: data.outlet.delivery_base_fee,
            delivery_extra_fee_per_km: data.outlet.delivery_extra_fee_per_km,
